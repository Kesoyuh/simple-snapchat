...
//                                                                               bottomVc: bottomVc)
        ...
        middleVertScrollVc = VerticalScrollViewController.verticalScrollVcWith(middleVc, topVc: topVc, bottomVc: bottomVc)
    ...
    func scrollViewWillBeginDragging(_ _scrollView: UIScrollView) {
